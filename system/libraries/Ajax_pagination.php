 ...
 * @TutorialLink http://www.Tutspointer.com/ajax-pagination-in-codeigniter-framework/
 */
class Ajax_pagination{
    ...
    function create_links(){
        ...
        ?>
        <script>
        function getData(page=2){  
            $.ajax({
                method: "POST",
                url: "<?php echo $this->base_url; ?>"+2,
                data: { page: 2 },
                beforeSend: function(){
