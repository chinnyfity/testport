...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 22, 2019 at 02:43 AM
...
INSERT INTO `cart` (`id`, `memid`, `prod_id`, `paid`, `locatn`, `payment_type`, `date_posted`) VALUES
(10, 5, 5, 1, '', '218682291', '2019-11-17 7:02 pm'),
(13, 2, 5, 0, '', 'mp', '2019-11-25 3:33 am');
...
INSERT INTO `centres` (`id`, `approved`, `centre_name`, `test_board`, `locations`, `statee`, `city`, `views`, `date_posted`) VALUES
(1, 1, 'Al-Miyzan Schools CBT Centre', 1, 'Al-Miyzan Close, Adams Estate, Ikotun, Lagos State', 'Lagos', 'Ikotun', 3, '2019-04-21 5:24 pm'),
(2, 1, 'Bachel Model College', 1, '3/5 Gardol Street, 7 Ifako Ijaiye, Ogba, Lagos State', 'Lagos', 'Ogba', 3, '2019-04-21 5:24 pm'),
(3, 1, 'Balad Private Schools,', 2, '1 Obafemi Street, Off Isawo Road, Agric-Owutu, Ikoyi, Lagos State', 'Lagos', 'Ikoyi', 3, '2019-04-21 5:24 pm'),
(4, 1, 'Dalware Institute Of Technology', 3, '31-33 Bode Thomas Road, Off Shyllon Str, Palm Groove,Lagos State Center ll', 'Lagos', 'Palm Groove', 7, '2019-04-21 5:24 pm'),
(5, 1, 'Universal Whitehall College', 1, '32/34 Daddy Salvage Street, Fagba Bus Stop, Iju Road, Ifako Ijaiye, Lagos State', 'Lagos', 'Ifako Ijaiye', 3, '2019-04-21 5:24 pm'),
(6, 1, 'Koncept Computer Enterprises Centre II', 1, '10 Chris Ogunbanjo Way, Opposite Coca-Cola Depot, Ijari, Ijebu-Ode 26, OGUN', 'OGUN', 'Ijebu-Ode', 1, '2019-04-21 5:24 pm'),
(7, 1, 'Lead British Intl School', 3, 'Aliyu Mustdafa Street (Opposite Trafford Hotel) Off Wole Soyinka Avenue, 2nd Avenue, Gwarinpa, Abuja', 'Abuja', 'Gwarinpa', 3, '2019-04-21 5:24 pm'),
(8, 1, 'Shoo Global Solutions Business Solution, Government Secondary School', 2, 'Along Custom Road, Wuse Zone 3, Abuja 26 FCT-ABUJA', 'Abuja', 'FCT-ABUJA', 4, '2019-04-21 5:24 pm'),
(9, 0, 'This is a centress', 1, 'gghgh', '', '', 0, '1573710045'),
(10, 1, 'mnmnmnm', 1, 'mnmn', '', '', 0, '2019-12-01 12:23 am');
...
INSERT INTO `email_verificatn` (`id`, `emails`, `codes`) VALUES
(7, '08035204317', 0),
(2, 'dans@yahoo.com', 0),
(6, 'donchibobo@gmail.com', 0);
...
CREATE TABLE `forums` (
  ...
  `files` varchar(30) CHARACTER SET latin1 NOT NULL,
  `views` int(11) NOT NULL,
  `dates` varchar(30) CHARACTER SET latin1 NOT NULL
...
(1, 6, 3, 'This is a raw talent show forum and i so much love it with passion, its one of the businesses i wanted to do before i got a job at the island in lagos \r\n\r\nThis is a raw talent show forum and i so much love it with passion, its one of the businesses i wanted to do before i got a job at the island in lagos ', '1557322899.jpg', 425, '2019-05-08 12:23 pm'),
(2, 2, 1, 'When it will be time to choose contestant, please let everyone be present as we choose randomly, thankss\r\nbnnbn\r\nshdjshdjs', '', 353, '2019-05-08 12:45 pm'),
(3, 2, 1, 'This is the real deal of fashion crazy. So chat me on web.whatsapp.com/sdhehanx\r\nAnd this is my website www.chinny.com or http://fffff.com', '', 191, '2019-05-08 12:49 pm'),
(6, 5, 3, 'sssdsnbds dsdsbbn dbsdbs', '', 33, '2019-05-14 12:33 pm'),
(7, 6, 2, 'this is what u do to make me happy', '', 22, '2019-06-07 8:16 am'),
(8, 5, 3, 'nmnmnmnm', '', 30, '2019-06-07 8:18 am'),
(15, 2, 2, 'dasdsadsa', '', 0, '2019-06-17 12:26 pm'),
(37, 6, 6, '*_Graduate Assistant_*\r\n*Ikeja*\r\n\r\n1. Assisting professors and departments with various administrative tasks.\r\n2. Organizing events.\r\n3. Finding information in libraries\r\n4. Undertaking various fieldwork research.\r\n5. Co-authoring research papers with their Supervisor .\r\n6. Conducting building staff meetings.\r\n7. Administering performance evaluations of student staff.\r\n8. Assisting with the management of ceremonies\r\n\r\nJob Type: Full-time\r\n\r\nSalary: ₦65,000.00 to ₦100,000.00 /month\r\n\r\nApply here\r\nhttps://ng.indeed.com/m/viewjob?from=serp&jk=4be8f065070c56c7&prevUrl=https://ng.indeed.com/m/jobs?sameL=1&q=&l=Lagos&from=searchOnSerp', '', 230, '2019-07-06 6:57 pm');
...
CREATE TABLE `forum_reply` (
  ...
  `replies` text CHARACTER SET utf8 NOT NULL,
...
(3, 1, 1, 'this is just a test', 'yyuyuyu.jpg', '2019-05-14 9:36 am'),
...
(7, 2, 2, 'bnbnbnbn', '676767.jpg', '2019-06-07 9:21 am'),
...
INSERT INTO `logos` (`id`, `urls`, `files`, `dates`) VALUES
(1, 'Hjhjhjhsss', '1576753560.jpg', '2019-12-19 12:06 pm');
...
INSERT INTO `members` (`id`, `approved`, `names`, `emails`, `passwords`, `phone`, `gender`, `pics`, `location`, `created_at`) VALUES
(2, 0, 'Chinny Anthony', 'donchibobo@gmail.com', '$2y$10$9ME6z3L1279r.Mz2rwq33etLzDr7HxRal5VKVqt557dMkKHOV0Ig6', '08035204317', 'm', '1574836095.jpg', '::1', '2019-10-27 6:40 pm'),
(5, 1, 'Kemi Abe', 'cgcvcbc', '', '', '', '', '41.190.31.43', '2004-10-27 10:40 pm'),
(6, 0, 'Oluchi Anthony', 'vbvb@ewewe.kkk', '$2y$10$rFMbRtHUVCmBiieqhcFfDO4P9qg67hcOF.1xeFveVhe05nYN23DI6', '65656566', 'f', '', '::1', '2019-11-22 12:14 am'),
(19, 0, 'shs shshsh', 'shshs@sss.sss', '$2y$10$CGzLuzLo8iTNQc2FZAZuD.YXHjvARo5GFV88Scp.F3cVJq0UxsD9q', '37373737', 'm', '', '::1', '2019-11-22 1:22 am');
...
INSERT INTO `quizes` (`id`, `test_board`, `subject_id`, `name_of_sch`, `years`, `sessions`) VALUES
(1, 1, 1, 1, '2016, 2018', 965186),
(7, 6, 8, 1, '2018, 2019', 966515),
(10, 1, 2, 1, '2016 - 2019', 140104),
(11, 6, 6, 1, '2019', 145544),
(12, 2, 2, 1, '2019', 638593);

-- --------------------------------------------------------

--
-- Table structure for table `quizes2`
--
...
--
-- Dumping data for table `quizes2`
--

INSERT INTO `quizes2` (`id`, `sessions`, `questions`, `files`, `op1`, `op2`, `op3`, `op4`, `ans1`, `explanations`) VALUES
(2, 965186, '<p>Which of the following best describes the image above?</p>', '1574965294.jpg', '3D Drawings', 'Oil Painting', 'Carving', 'Ready Made Image', 'Oil Painting', ''),
(3, 965186, '<p>A rich man that lived in a beautiful house on Baker Street, Mr. Ronald Green, has just been kidnapped and Sherlock Holmes has been appointed to the case. He finds a note at the crime scene written by Mr. Green. It read:</p><p><br></p><p>"First of January, Fourth of October, Fifth of March, Third of June."</p><p><br></p><p>Sherlock knew that somehow, the killer’s name was hidden in the note, who''s the killer?</p>', '1560346739.jpg', 'Jack Green, the son and the heir of the property', 'John Jacobson, an employee of Mr. Green', 'June Green, Green’s wife', 'Sherlock Holmes, investigator', 'John Jacobson, an employee of Mr. Green', 'Read this line and get the explanation to the question\r\n\r\n"First of January, Fourth of October, Fifth of March, Third of June."'),
(4, 965186, '<p>One snowy night, Sherlock Holmes was in his house sitting by the fire. All of a sudden a snowball came crashing through his window and broke it. Holmes got up and looked out the window just in time to see 3 neighborhood kids who were brothers run around a corner. Their names were John Crimson, Mark Crimson, and Paul Crimson. The next day Holmes got a note that read: "? Crimson. He broke your window."</p><p><br></p><p>Which of the 3 Crimson brothers should Sherlock Holmes question about the incident?</p>', '1574966146.jpg', 'John Crimson', 'Mark Crimson', 'Paul Crimson', '', 'Mark Crimson', 'Check the question mark which represents the option B'),
(5, 966515, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', 'Study the roman numerals'),
(6, 966515, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(7, 966515, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', 'All are buy and sell portals except for jobberman which is for job portal'),
(8, 966515, 'Look at this image and answer choose the correct answer', NULL, '3', '4', '6', '8', '8', ''),
(9, 966515, '<p>From the picture, how many people came to the picnic and how did they get there?</p>', '1575021619.jpg', '4 People; Came By Leg', '4 People; Came By Boat', '3 People; Came By Leg', '3 People; Came By Car', '4 People; Came By Boat', 'Note that the place is an isolated area'),
(18, 140104, '<p>In a class of 30 students, how many pairs of legs can be counted?</p>', NULL, 'XXX', 'LX', 'XL', 'CCC', 'XXX', 'Study your roman numerals'),
(19, 140104, '<p>If p=3, q=4 and r=q+p, what is r-p?</p>', NULL, 'q', 'p', 'r', 'p+r', 'q', ''),
(20, 140104, '<p>What is the name of the horror American movie that a doll baby loves to kill and destroy people?</p>', '1575140317.jpg', 'Baby&prime;s day out', 'Dracula II', 'Monster Baby', 'Chucky', 'Chucky', ''),
(21, 140104, '<p>One of these below has the same sound as <strong><u>kn</u></strong>ownledge. Note the underlined letters.</p>', NULL, 'Mock', 'Kiss', 'Burn', 'Course', 'Burn', ''),
(22, 140104, '<p>In the Nigerian movie, "Husbands of Lagos", Uche Oduputa best played the roles of a _______</p>', '1575140458.jpg', 'Principled Man', 'Stingy Igbo Man', '419ner', 'Illiterate Man', 'Stingy Igbo Man', ''),
(23, 145544, '<p>In a chemist store owned by ONLY Adamu, he bought 5 panadol for N5 each, 10 flagyl for N2 each and 4 pieces of blood tonic for N3 each, how much did Musa buy 2 panadol and 1 flagyl?</p>', NULL, 'N7', 'N10', 'N12', 'None', 'None', ''),
(24, 145544, '<p>This is another&prime;s test with apostrophe </p>', NULL, 'this is the girl`s bagss', 'bnbnb', 'cvcvfgf', 'gfgffg and the guy&prime;s', 'bnbnb', '');

-- --------------------------------------------------------

--
-- Table structure for table `quizes2_delete`
--

CREATE TABLE `quizes2_delete` (
  `id` int(11) NOT NULL,
  `sessions` int(11) NOT NULL,
  `questions` text NOT NULL,
  `files` varchar(100) DEFAULT NULL,
...
--
-- Dumping data for table `quizes2_delete`
--

INSERT INTO `quizes2_delete` (`id`, `sessions`, `questions`, `files`, `op1`, `op2`, `op3`, `op4`, `ans1`, `explanations`) VALUES
(2, 830297, 'Which of the following best describes the image above?', '1555862211.jpg', '3D Drawing', 'Oil Painting', 'Carving', 'Ready made image', 'Oil Painting', ''),
(4, 830297, 'A rich man that lived in a beautiful house on Baker Street, Mr. Ronald Green, has just been kidnapped and Sherlock Holmes has been appointed to the case. He finds a note at the crime scene written by Mr. Green. It read:\r\n\r\n"First of January, Fourth of October, Fifth of March, Third of June."\r\n\r\nSherlock knew that somehow, the killer’s name was hidden in the note, who''s the killer?', '1560346739.jpg', 'Jack Green, the son and the heir of the property', 'John Jacobson, an employee of Mr. Green', 'June Green, Green’s wife', 'Sherlock Holmes, investigator', 'John Jacobson, an employee of Mr. Green', ''),
(5, 830297, 'One snowy night, Sherlock Holmes was in his house sitting by the fire. All of a sudden a snowball came crashing through his window and broke it. Holmes got up and looked out the window just in time to see 3 neighborhood kids who were brothers run around a corner. Their names were John Crimson, Mark Crimson, and Paul Crimson. The next day Holmes got a note that read: "? Crimson. He broke your window."\r\n\r\nWhich of the 3 Crimson brothers should Sherlock Holmes question about the incident?', '1560346904.jpg', 'John Crimson', 'Mark Crimson', 'Paul Crimson', '', 'Mark Crimson', ''),
(6, 830297, 'Look at this image and answer choose the correct answer', '1560347332.jpg', '3', '4', '6', '8', '8', ''),
(9, 830297, 'From the picture, how many people came to the picnic and how did they get there?', '1560527935.jpg', '4 people; came by leg', '4 people; came by boat', '3 people; came by leg', '3 people; came by car', '4 people; came by boat', ''),
(10, 999222, 'I went to bed at 8 o clock in the evening and wound up my clock and set the alarm to sound at 9 o clock in the morning. How many hours sleep would i get before awoken by the alarm?', NULL, '13 hours', '12 hours', '1 hour', '2 hours', '1 hour', ''),
(11, 999222, '9 o clock is equivalent to how many degrees?', NULL, '45 degrees', '90 degrees', '180 degrees', '270 degrees', '90 degrees', ''),
(12, 999222, 'In a class of 30 students, how many pairs of legs can be counted?', NULL, 'XXX', 'LX', 'XL', 'CCC', 'XXX', ''),
(13, 999222, 'If p=3, q=4 and r=q+p, what is r-p?', NULL, 'q', 'p', 'r', 'p+r', 'q', ''),
(14, 999222, 'What is the name of the horror American movie that a doll baby loves to kill and destroy people?', 'ChildsPlay.jpg', 'Baby''s day out', 'Dracula II', 'Monster Baby', 'Chucky', 'Chucky', ''),
(15, 666000, '<p>One of these below has the same sound as<strong> <u>kn</u></strong>ownledge. Note the underlined letters.</p>', NULL, 'Mock', 'Kiss', 'Burn', 'Course', 'Burn', ''),
(16, 666000, 'In the Nigerian movie, "Husbands of Lagos", Uche Oduputa best played the roles of a _______', 'uche.jpg', 'Principled man', 'Stingy Igbo man', '419ner', 'illiterate Man', 'Stingy Igbo man', ''),
(17, 666000, 'In a chemist store owned by ONLY Adamu, he bought 5 panadol for N5 each, 10 flagyl for N2 each and 4 pieces of blood tonic for N3 each, how much did Musa buy 2 panadol and 1 flagyl?', NULL, 'N7', 'N10', 'N12', 'None', 'None', ''),
(19, 666000, '<p>What is the value of x in 5x-4=4</p>', NULL, '4', '5', '5', 'none', '5', ''),
(21, 666001, '<p>From the image below, what is the value of p</p>', '1567695378.jpg', '4.4', '5', '6', '20', '4.4', ''),
(52, 666001, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', ''),
(53, 666001, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(54, 666001, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', '');

-- --------------------------------------------------------

--
-- Table structure for table `quizes_backup`
--

CREATE TABLE `quizes_backup` (
  `id` int(11) NOT NULL,
  `quizintro_id` int(11) NOT NULL,
  `test_board` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
  `name_of_sch` int(11) NOT NULL,
...
--
-- Dumping data for table `quizes_backup`
--

INSERT INTO `quizes_backup` (`id`, `quizintro_id`, `test_board`, `subject_id`, `name_of_sch`, `years`, `sessions`, `questions`, `files`, `op1`, `op2`, `op3`, `op4`, `ans1`, `explanations`) VALUES
(1, 2, 1, 2, 0, 2016, 0, 'This is the first questionsss', '1556017537.jpg', 'this is option 1', 'fsdfdsfdsfd', 'ddddd', 'sssddddss', 'fsdfdsfdsfd', ''),
(2, 2, 2, 2, 0, 2016, 0, 'Which of the following best describes the image above?', '1555862211.jpg', '3D Drawing', 'Oil Painting', 'Carving', 'Ready made image', 'Oil Painting', ''),
(4, 2, 3, 2, 0, 2016, 0, 'A rich man that lived in a beautiful house on Baker Street, Mr. Ronald Green, has just been kidnapped and Sherlock Holmes has been appointed to the case. He finds a note at the crime scene written by Mr. Green. It read:\r\n\r\n"First of January, Fourth of October, Fifth of March, Third of June."\r\n\r\nSherlock knew that somehow, the killer’s name was hidden in the note, who''s the killer?', '1560346739.jpg', 'Jack Green, the son and the heir of the property', 'John Jacobson, an employee of Mr. Green', 'June Green, Green’s wife', 'Sherlock Holmes, investigator', 'John Jacobson, an employee of Mr. Green', ''),
(5, 2, 3, 2, 0, 2016, 0, 'One snowy night, Sherlock Holmes was in his house sitting by the fire. All of a sudden a snowball came crashing through his window and broke it. Holmes got up and looked out the window just in time to see 3 neighborhood kids who were brothers run around a corner. Their names were John Crimson, Mark Crimson, and Paul Crimson. The next day Holmes got a note that read: "? Crimson. He broke your window."\r\n\r\nWhich of the 3 Crimson brothers should Sherlock Holmes question about the incident?', '1560346904.jpg', 'John Crimson', 'Mark Crimson', 'Paul Crimson', '', 'Mark Crimson', ''),
(6, 2, 3, 2, 0, 2016, 0, 'Look at this image and answer choose the correct answer', '1560347332.jpg', '3', '4', '6', '8', '8', ''),
(9, 43, 2, 2, 0, 2017, 0, 'From the picture, how many people came to the picnic and how did they get there?', '1560527935.jpg', '4 people; came by leg', '4 people; came by boat', '3 people; came by leg', '3 people; came by car', '4 people; came by boat', ''),
(10, 4, 1, 3, 0, 2017, 0, 'I went to bed at 8 o clock in the evening and wound up my clock and set the alarm to sound at 9 o clock in the morning. How many hours sleep would i get before awoken by the alarm?', NULL, '13 hours', '12 hours', '1 hour', '2 hours', '1 hour', ''),
(11, 2, 2, 3, 0, 2017, 0, '9 o clock is equivalent to how many degrees?', NULL, '45 degrees', '90 degrees', '180 degrees', '270 degrees', '90 degrees', ''),
(12, 6, 3, 3, 0, 2017, 0, 'In a class of 30 students, how many pairs of legs can be counted?', NULL, 'XXX', 'LX', 'XL', 'CCC', 'XXX', ''),
(13, 2, 4, 3, 0, 2017, 0, 'If p=3, q=4 and r=q+p, what is r-p?', NULL, 'q', 'p', 'r', 'p+r', 'q', ''),
(14, 2, 4, 3, 0, 2018, 0, 'What is the name of the horror American movie that a doll baby loves to kill and destroy people?', 'ChildsPlay.jpg', 'Baby''s day out', 'Dracula II', 'Monster Baby', 'Chucky', 'Chucky', ''),
(15, 2, 4, 3, 0, 2018, 0, '<p>One of these below has the same sound as<strong> <u>kn</u></strong>ownledge. Note the underlined letters.</p>', NULL, 'Mock', 'Kiss', 'Burn', 'Course', 'Burn', ''),
(16, 4, 4, 3, 0, 2018, 0, 'In the Nigerian movie, "Husbands of Lagos", Uche Oduputa best played the roles of a _______', 'uche.jpg', 'Principled man', 'Stingy Igbo man', '419ner', 'illiterate Man', 'Stingy Igbo man', ''),
(17, 4, 5, 3, 0, 2018, 0, 'In a chemist store owned by ONLY Adamu, he bought 5 panadol for N5 each, 10 flagyl for N2 each and 4 pieces of blood tonic for N3 each, how much did Musa buy 2 panadol and 1 flagyl?', NULL, 'N7', 'N10', 'N12', 'None', 'None', ''),
(18, 4, 5, 4, 0, 2014, 0, '<p>this is just a test</p>', '1567071961.jpg', 'fdfd', 'fgfdg', 'fdgfd', 'gfgfd', 'fdgfd', ''),
(19, 4, 5, 4, 0, 2014, 0, '<p>What is the value of x in 5x-4=4</p>', NULL, '4', '5', '5', 'none', '5', ''),
(20, 4, 5, 4, 0, 2014, 0, '<p>this is another question</p>', NULL, 'first option', 'sec option', 'third option', '4th option', 'third option', ''),
(21, 2, 6, 4, 1, 2014, 0, '<p>From the image below, what is the value of p</p>', '1567695378.jpg', '4.4', '5', '6', '20', '4.4', ''),
(26, 45, 6, 4, 1, 2014, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '', ''),
(27, 6, 6, 4, 1, 2014, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', '', ''),
(28, 6, 6, 5, 1, 2014, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', '', ''),
(29, 6, 7, 5, 1, 2014, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '', ''),
(30, 6, 6, 5, 1, 2014, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', '', ''),
(31, 6, 7, 5, 0, 2016, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', '', ''),
(32, 6, 1, 5, 0, 2016, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', ''),
(33, 2, 1, 2, 0, 2016, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(34, 2, 1, 2, 0, 2016, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', ''),
(35, 2, 1, 2, 0, 2016, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', ''),
(36, 2, 1, 2, 0, 2016, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(37, 4, 1, 2, 0, 2016, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', ''),
(38, 4, 1, 2, 0, 2016, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', ''),
(39, 4, 2, 3, 0, 2016, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(40, 4, 2, 3, 0, 2016, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', ''),
(49, 2, 1, 3, 0, 2017, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', ''),
(50, 6, 2, 3, 0, 2017, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(51, 6, 2, 4, 0, 2017, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', ''),
(52, 6, 3, 4, 0, 2018, 0, 'Which of the following is not the right answer?', NULL, '2+2=4', 'I+III = IV', '20-XV=4', '4-0=4', '20-XV=4', ''),
(53, 6, 3, 4, 0, 2018, 0, 'The following people are staff of SuccessDrives company except?', NULL, 'Chinny Anthony', 'Abiodun', 'Lateef', 'Kenny', 'Abiodun', ''),
(54, 6, 1, 6, 0, 2019, 0, 'Pick the odd one out from the following', NULL, 'konga.com', 'jiji.ng', 'jobberman.com', 'jumia.com', 'jobberman.com', '');
...
INSERT INTO `quizes_intro` (`id`, `sessions`, `aprvd`, `instructn`, `set_time`, `dates`) VALUES
(1, 965186, 1, 'You are to answer all the questions here, you will be given 20 minutes to attempt all the questions, its simple but logical questions.', 20, '2019-11-28 7:19 pm'),
(2, 966515, 1, 'You are to answer all the questions here, you will be given 20 minutes to attempt all the questions, its simple but logical questions.', 30, '2019-11-28 7:41 pm'),
(7, 140104, 1, 'You are to answer all the questions here, you will be given 20 minutes to attempt all the questions, its simple but logical questions.', 30, '2019-11-30 7:55 pm'),
(8, 145544, 1, 'You are to answer all the questions here, you will be given 20 minutes to attempt all the questions, its simple but logical questions.', 30, '2019-11-30 9:25 pm'),
(9, 638593, 1, 'You are to answer all the questions here, you will be given 20 minutes to attempt all the questions, its simple but logical questions.', 20, '2019-12-18 4:09 am');

-- --------------------------------------------------------

--
-- Table structure for table `quizes_intro_backup`
--

CREATE TABLE `quizes_intro_backup` (
  `id` int(11) NOT NULL,
  `test_board` int(11) NOT NULL,
...
--
-- Dumping data for table `quizes_intro_backup`
--

INSERT INTO `quizes_intro_backup` (`id`, `test_board`, `subject_id`, `years`, `sessions`, `aprvd`, `instructn`, `name_of_sch`, `set_time`, `dates`) VALUES
(2, 1, 2, '2016', 0, 1, 'You are to answer all the questions to win the chances of a scholarship award, all questions carry equal marks. Once your timing goes zero (0), your answers will automatically be submitted.', 1, 11, '2019-04-21 5:24 pm'),
(4, 1, 2, '2017', 0, 1, 'You are to answer all the questions to win the chances of a scholarship award, all questions carry equal marks. Once your timing goes zero (0), your answers will automatically be submitted.', 2, 12, '2019-04-30 1:06 am'),
(6, 3, 3, '2018', 0, 1, 'You are to answer all the questions to win the chances of a scholarship award, all questions carry equal marks. Once your timing goes zero (0), your answers will automatically be submitted.', 0, 6, '2019-06-12 2:27 pm'),
(43, 1, 4, '2017', 0, 1, 'Nill', 1, 20, '2019-04-21 5:24 pm'),
(44, 6, 4, '2017', 0, 1, 'nill', 1, 20, '2019-04-21 5:24 pm'),
(45, 6, 6, '2014', 0, 1, 'nill', 1, 20, '2019-04-21 5:24 pm'),
(46, 5, 4, '2019', 0, 1, 'nill', 0, 20, '2019-04-21 5:24 pm'),
(47, 7, 7, '2016', 0, 1, 'nill', 0, 20, '2019-04-21 5:24 pm'),
(54, 2, 1, '2344', 818912, 1, 'dsfsd', 1, 33, '2019-11-15 12:55 pm'),
(55, 2, 2, '2344', 818912, 1, 'dsfsd', 0, 33, '2019-11-15 12:55 pm');
...
CREATE TABLE `resources` (
  ...
  `test_board` varchar(100) NOT NULL,
  `titles` varchar(100) NOT NULL,
  `descrip` text NOT NULL,
  `img_cover` varchar(30) NOT NULL,
...
INSERT INTO `resources` (`id`, `media_type`, `test_board`, `titles`, `descrip`, `img_cover`, `files`, `file_type`, `price`, `years`, `downloads`, `views`, `date_uploaded`) VALUES
(1, 'doc', '6,7', 'Post-UTME Past Questions & Answers', '', 'post-utme-past-questions.jpg', '3_products.doc', 'hardcopy', 3000, '2017, 2018, 2019', 0, 35, '2019-10-15 11:21 am'),
(2, 'doc', '1,5', 'Jamb Chemistry Questions & Answers', '', 'jamb_chemistry.jpg', '3_products.doc', 'softcopy', 0, '2018', 3, 58, '2019-10-15 11:21 am'),
(3, 'doc', '1,2,3,5,7', 'Jamb Use of English Past Questions & Answers with explanations', '', 'jamb_english.jpg', '3_products.doc', 'hardcopy', 5000, '1990 - 2018', 6, 34, '2019-10-15 11:21 am'),
(4, 'doc', '1', 'Physics WAEC Questions & Answers', 'This files contains a softcopy of Physics WAEC Questions & Answers including a step by step explaination on each answer.\r\n\r\nThe answers and explainations were gotten direct from the exam board marking scheme, order for it and be sure to pass your physics exams.', 'waec_physics.jpg', '3_products.doc', 'softcopy', 3500, '2008-2011', 2, 122, '2019-10-15 11:21 am'),
(5, 'doc', '1,2,3', 'Chemistry past questions & answers', '', 'waec_questions.jpg', '3_products.doc', 'softcopy', 2500, '2017 - 2019', 0, 97, '2019-10-15 11:21 am'),
(6, 'vid', '1', 'tutorials on how to answer jamb questions with new tricks', '', 'vid3.jpg', 'TRU6A9PKVY57HEC.mp4', 'softcopy', 0, '2018 - 2019', 0, 17, '2019-10-15 11:21 am'),
(7, 'vid', '5', 'How to answer post-UTME question training', '', 'vid2.jpg', 'TRU6A9PKVY57HEC.mp4', 'softcopy', 0, '2019', 0, 0, '2019-10-15 11:21 am'),
(8, 'vid', '3', 'Marking scheme on WAEC past questions and answers tutorials', '', 'vid1.jpg', 'TRU6A9PKVY57HEC.mp4', 'softcopy', 0, '2018', 1, 258, '2019-10-15 11:21 am'),
(9, 'vid', '1,4', 'Biology practicals', '', 'post_utme_questions.jpg', 'TRU6A9PKVY57HEC.mp4', 'softcopy', 0, '2017, 2018, 2019', 0, 8, '2019-10-15 11:21 am'),
(12, 'doc', '1,2', 'bnbbnbgh', '<p>this is the content</p><p>and this is a break line</p>', '1573990739.png', '1573965376.pdf', 'hardcopy', 6000, '2018,2010', 0, 10, '2019-11-17 5:36 am');
...
CREATE TABLE `schools` (
  `id` int(11) NOT NULL,
  `name_of_sch` varchar(100) NOT NULL,
...
INSERT INTO `schools` (`id`, `name_of_sch`, `sch_logo`) VALUES
(1, 'university of jos', 'unijos.jpg'),
(2, 'ekiti state university', 'eksu.jpg');
...
INSERT INTO `stud_ans` (`id`, `memid`, `quizintro_id`, `subject_id`, `answers`, `ids`, `time_finished`, `scores`, `date_taken`) VALUES
(2, 2, 7, '2', 'r||XXX||Stingy Igbo Man||Chucky||Mock', '19,18,22,20,21', 1760, '60', '1576435756'),
(8, 2, 7, '2', 'Chucky', '20', 1785, '20', '1576744221'),
(11, 2, 7, '2', 'Mock||Mock||Mock', '21,21,21', 0, '0', '1576839756'),
(12, 2, 7, '2', 'XXX||XXX||XXX||XXX||Chucky||Burn||Principled Man', '18,18,18,18,20,21,22', 1733, '120', '1576840068'),
(13, 2, 7, '2', 'Burn||Burn||p r||XXX', '21,21,19,18', 1773, '60', '1576840199'),
(16, 2, 7, '2', '0', '0', 1734, '0', '1576857988'),
(17, 2, 7, '2', '0', '2', 1592, '0', '1576858206'),
(18, 2, 7, '2', '0', '2', 1795, '0', '1576859228'),
(19, 2, 7, '2', '0', '2', 0, '0', '1576859466'),
(20, 2, 7, '2', '0', '2', 0, '0', '1576907304'),
(21, 2, 7, '2', '0', '19,', 1797, '0', '1576910310'),
(22, 2, 7, '2', '0', '1919', 1797, '0', '1576910451'),
(23, 2, 7, '2', '0', '2', 1780, '0', '1576911594'),
(24, 2, 7, '2', '0', '1818', 1797, '0', '1576912043'),
(25, 2, 7, '2', '0', '20, 20,, 22', 1794, '0', '1576912589'),
(26, 2, 1, '1', '0', '', 0, '0', '1576912717'),
(27, 2, 7, '2', '0', '20,20,21,18', 0, '0', '1576932777');
...
--
-- Dumping data for table `stud_start_test`
--

INSERT INTO `stud_start_test` (`id`, `memid`, `quiz_intro_id`, `subject_id`, `started_test`, `attempts`) VALUES
(1, 2, 7, '2', 1, -380),
(2, 2, 1, '1', 1, 1);
...
INSERT INTO `subjects` (`id`, `subjs`) VALUES
(1, 'English Language'),
(2, 'Mathematics'),
...
(22, 'Government'),
(23, 'Nigeria Language(Igbo)'),
(24, 'Nigeria Language(Hausa)'),
(25, 'Nigeria Language(Yoruba)'),
(26, 'Visual Arts'),
...
--
-- Table structure for table `test_boards`
--

CREATE TABLE `test_boards` (
  `id` int(11) NOT NULL,
  `test_types` varchar(30) NOT NULL,
  `views` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `test_boards`
--

INSERT INTO `test_boards` (`id`, `test_types`, `views`) VALUES
(1, 'Jamb Test', 1649),
(2, 'WAEC Test', 3),
(3, 'NECO Test', 14),
(4, 'UNILAG Diploma', 1),
(5, 'Mock Test', 73),
(6, 'POST UTME Test', 550),
(7, 'Common Entrance', 2),
(8, 'ICAN', 1),
(9, 'N-Power', 0),
(10, 'OAU Pre-Degree', 0),
...
INSERT INTO `user_locations` (`id`, `ipaddrs`, `statee`, `citys`) VALUES
(1, '41.190.31.43', 'Lagos', 'Ikoyi'),
(2, '::1', '', ''),
(3, '::1', NULL, NULL),
(4, '105.112.18.32', 'Lagos', 'Lagos'),
(5, '105.112.29.137', 'Lagos', 'Lagos'),
(6, '105.112.29.240', 'Lagos', 'Lagos'),
(7, '105.112.53.204', 'Lagos', 'Lagos'),
(8, '82.145.223.5', 'Western Cape', 'Cape Town'),
(9, '197.210.44.130', 'Lagos', 'Lagos'),
(10, '197.211.58.210', 'Ondo', 'Akure'),
(11, '197.210.29.136', 'Lagos', 'Lagos'),
(12, '105.112.50.206', 'Lagos', 'Lagos'),
(13, '197.210.44.76', 'Lagos', 'Lagos'),
(14, '197.210.28.253', 'Lagos', 'Lagos'),
(15, '105.112.72.144', 'Lagos', 'Lagos'),
(16, '197.210.28.31', 'Lagos', 'Lagos'),
(17, '197.210.47.81', 'Lagos', 'Lagos'),
(18, '197.210.45.204', 'Lagos', 'Lagos'),
(19, '41.203.73.81', 'Enugu', 'Enugu'),
(20, '105.112.46.255', 'Lagos', 'Lagos'),
(21, '197.210.47.41', 'Lagos', 'Lagos'),
(22, '129.205.113.170', 'Lagos', 'Lagos'),
(23, '41.190.3.194', 'Lagos', 'Lagos'),
(24, '197.210.45.173', 'Lagos', 'Lagos'),
(25, '82.145.223.6', 'Western Cape', 'Cape Town'),
(26, '197.210.44.52', 'Lagos', 'Lagos'),
(27, '105.112.23.41', 'Lagos', 'Lagos'),
(28, '197.210.47.32', 'Lagos', 'Lagos'),
(29, '197.210.57.7', 'Niger', 'Suleja'),
(30, '197.210.57.64', 'Niger', 'Suleja'),
(31, '197.210.57.7', 'Ogun', 'Abeokuta'),
(32, '105.112.72.249', 'Lagos', 'Lagos'),
(33, '197.210.58.15', 'Ogun', 'Abeokuta'),
(34, '197.210.57.132', 'Ogun', 'Abeokuta');
...
--
-- Indexes for table `quizes2`
--
ALTER TABLE `quizes2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sessions1` (`op1`,`op2`,`op3`,`op4`,`ans1`);

--
-- Indexes for table `quizes2_delete`
--
ALTER TABLE `quizes2_delete`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sessions1` (`op1`,`op2`,`op3`,`op4`,`ans1`);

--
-- Indexes for table `quizes_backup`
--
ALTER TABLE `quizes_backup`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sessions1` (`quizintro_id`,`op1`,`op2`,`op3`,`op4`,`ans1`);
...
ALTER TABLE `quizes_intro`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sessions1` (`aprvd`,`set_time`);

--
-- Indexes for table `quizes_intro_backup`
--
ALTER TABLE `quizes_intro_backup`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sessions1` (`test_board`,`subject_id`,`aprvd`,`set_time`);
...
ALTER TABLE `stud_ans`
  ADD PRIMARY KEY (`id`),
  ADD KEY `memid` (`memid`,`quizintro_id`,`time_finished`,`scores`);
...
--
-- Indexes for table `test_boards`
--
ALTER TABLE `test_boards`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `quizes2`
--
ALTER TABLE `quizes2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `quizes2_delete`
--
ALTER TABLE `quizes2_delete`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT for table `quizes_backup`
--
ALTER TABLE `quizes_backup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
...
--
-- AUTO_INCREMENT for table `quizes_intro_backup`
--
ALTER TABLE `quizes_intro_backup`
...
--
-- AUTO_INCREMENT for table `test_boards`
--
ALTER TABLE `test_boards`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
